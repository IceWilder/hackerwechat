...
{ 
if(obj.value.length!=strFormat.length)
    obj.value='';
...
if (this.dateControl != null){
    ...
    if(this.dateControl.value.length==10){//当是yyyy-MM-dd 时自动添上23:59:59  如其它地方使用 再加判断
        this.dateControl.value+=" 23:59:59";
    }
}
...
{ 
var str = '<div id="calendarPanel" style="position: fixed;display: none;z-index:9999; background-color: #FFFFFF;border: 1px solid #CCCCCC;width:175px;font-size:12px;"></div>';
if(document.all) 
{ 
