 ...
 * 	Scope为snsapi_base
 */
exports.createOauthUrlForCode = function (redirectUrl,appid,from_openid){
    var urlJson = {};
    var state = from_openid ? from_openid : "STATE";
    urlJson["appid"] = appid;
    urlJson["redirect_uri"] = redirectUrl;
    urlJson["response_type"] = "code";
    urlJson["scope"] = "snsapi_base";
 ...
 */
exports.createOauthUrlForCodeUInfo = function (redirectUrl,appid,from_openid){
    var urlJson = {};
    var state = from_openid ? from_openid : "STATE";
    urlJson["appid"] = appid;
    urlJson["redirect_uri"] = redirectUrl;
    urlJson["response_type"] = "code";
    urlJson["scope"] = "snsapi_userinfo";
    urlJson["state"] = state + "#wechat_redirect";
 ...
 */
exports.createOauthUrlForAccessToken = function (appid,secret,code){
    var urlJson = {};
    urlJson["appid"] = appid;
    urlJson["secret"] = secret;
    urlJson["code"] = code;
    urlJson["grant_type"] = "authorization_code";
...
/**
 * 	作用：根据access_token和openid拉取用户信息
 */
exports.createOauthUrlForUserinfo = function (access_token,openid){
    var urlJson = {};
    urlJson["access_token"] = access_token;
    urlJson["openid"] = openid;
    urlJson["lang"] = "zh_CN";
